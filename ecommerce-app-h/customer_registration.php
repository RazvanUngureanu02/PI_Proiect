	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				<a href="index.php" class="navbar-brand">xPharm Online</a>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading text-center">Inregistrare client nou</div>
					...
					<form id="signup_form" onsubmit="return false">
						...
						<div class="row">
							<div class="col-md-12">
								<input style="width:100%;" value="Inregistrare" type="submit" name="signup_button"class="btn btn-success btn-lg">
							</div>
						</div>
