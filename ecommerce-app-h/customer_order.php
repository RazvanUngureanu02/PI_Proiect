								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>NUME</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<tr><td>PRET PRODUS</td><td><b><?php echo $row["product_price Lei"]; ?></b></td></tr>
													<tr><td>CANTITATE</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
													<tr><td>ID TRANZACTIE</td><td><b><?php echo $row["trx_id"]; ?></b></td></tr>
												</table>
											</div>
										</div>
									<?php
